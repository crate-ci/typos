...
![Screenshot](https://github.com/crate-ci/typos/raw/main/docs/screenshot.png)


[![Downloads](https://img.shields.io/github/downloads/crate-ci/typos/total.svg)](https://github.com/crate-ci/typos/releases)
[![codecov](https://codecov.io/gh/crate-ci/typos/branch/main/graph/badge.svg)](https://codecov.io/gh/crate-ci/typos)
...
- [Getting Started](#getting-started)
  ...
  - [Integrations](#integrations)
    - [GitHub Action](https://github.com/crate-ci/typos/blob/main/docs/github-action.md)
    - [pre-commit](https://github.com/crate-ci/typos/blob/main/docs/pre-commit.md)
    - [Custom](#custom)
  - [Debugging](#debugging)
- [Reference](https://github.com/crate-ci/typos/blob/main/docs/reference.md)
- [FAQ](#faq)
- [Comparison with other spell checkers](https://github.com/crate-ci/typos/blob/main/docs/comparison.md)
- [Projects using typos](https://github.com/crate-ci/typos/wiki)
- [Benchmarks](benchsuite/runs)
- [Design](https://github.com/crate-ci/typos/blob/main/docs/design.md)
...
To mark a word or an identifier (grouping of words) as valid, add it to your [`_typos.toml`](https://github.com/crate-ci/typos/blob/main/docs/reference.md) by declaring itself as the valid spelling:
```toml
[default]
...
teh = "teh"
```
For more ways to ignore or extend the dictionary with examples, see the [config reference](https://github.com/crate-ci/typos/blob/main/docs/reference.md).
...
- [GitHub Actions](https://github.com/crate-ci/typos/blob/main/docs/github-action.md)
- [pre-commit](https://github.com/crate-ci/typos/blob/main/docs/pre-commit.md)
...
For more on the trade offs of these approaches, see [Design](https://github.com/crate-ci/typos/blob/main/docs/design.md).
